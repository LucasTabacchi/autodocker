...
AUTODOCKER_PREVIEW_MAX_TTL_SECONDS = int(
    env("AUTODOCKER_PREVIEW_MAX_TTL_SECONDS", "2700")
)
...
AUTODOCKER_PREVIEW_RUNNER_MAX_ACTIVE_SESSIONS = int(
    env("AUTODOCKER_PREVIEW_RUNNER_MAX_ACTIVE_SESSIONS", "2")
)
AUTODOCKER_PREVIEW_CADDY_ENABLED = env_bool(
    "AUTODOCKER_PREVIEW_CADDY_ENABLED",
    default=AUTODOCKER_DEPLOYMENT_ROLE == "preview_runner",
)
AUTODOCKER_PREVIEW_CADDY_CONFIG_PATH = env(
    "AUTODOCKER_PREVIEW_CADDY_CONFIG_PATH",
    "/etc/caddy/Caddyfile",
)
AUTODOCKER_PREVIEW_CADDY_ROUTES_DIR = env(
    "AUTODOCKER_PREVIEW_CADDY_ROUTES_DIR",
    "/etc/caddy/routes",
)
AUTODOCKER_PREVIEW_CADDY_RELOAD_COMMAND = env(
...
AUTODOCKER_PREVIEW_PER_SESSION_CPU = env(
    "AUTODOCKER_PREVIEW_PER_SESSION_CPU",
    "0.75",
)
AUTODOCKER_PREVIEW_PER_SESSION_MEMORY_MB = int(
    env("AUTODOCKER_PREVIEW_PER_SESSION_MEMORY_MB", "2560")
)
AUTODOCKER_PREVIEW_HTTP_READY_TIMEOUT_SECONDS = int(
    env("AUTODOCKER_PREVIEW_HTTP_READY_TIMEOUT_SECONDS", "75")
)
